...
import 'package:ashtottara_shantanamavali/AdsHelper/adshelper.dart';
import 'package:ashtottara_shantanamavali/utils/LordAyyappanNameList.dart';
...
class LordAyyappanNameListScreen extends StatefulWidget {
  final int listIndex;

  const LordAyyappanNameListScreen({Key? key,required this.listIndex}) : super(key: key);

  @override
  _LordAyyappanNameListScreenState createState() => _LordAyyappanNameListScreenState(listIndex);
}

class _LordAyyappanNameListScreenState extends State<LordAyyappanNameListScreen> {

  bool isLanguageSelected = false;

  final int listIndex;

  _LordAyyappanNameListScreenState(this. listIndex);  //constructor
              ...
              children: [
                ...
                Expanded(
                    ...
                    ListView.builder(
                      ...
                      shrinkWrap: true,
                      itemCount:  lordAyyappanHindi.length,
                              ...
                              children: [
                                ...
                                Expanded(
                                  ...
                                  child: Padding(
                                    ...
                                    child: Text(lordAyyappanHindi[i] ,
                ...
                Expanded(
                    ...
                    ListView.builder(
                      physics: const NeverScrollableScrollPhysics(),
                      shrinkWrap: true,
                      itemCount: lordAyyappanEnglish.length,
                      itemBuilder: (context, i) {
                        return Column(
                          children: [
                            Row(
                              children: [
                                ...
                                Expanded(
                                  ...
                                  child: Padding(
                                    padding: const EdgeInsets.all(8.0),
                                    child: Text(""+lordAyyappanEnglish[i], style: GoogleFonts.aBeeZee(fontSize: 21.5, color: kprimarycolor,height: 1.5),textAlign: TextAlign.start,),
                                  ),
                                ),
                              ],
                            ),
