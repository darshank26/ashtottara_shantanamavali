...
class LordKrishnaNameListScreen extends StatefulWidget {
  final int listIndex;

  const LordKrishnaNameListScreen({Key? key,required this.listIndex}) : super(key: key);

  @override
  _LordKrishnaNameListScreenState createState() => _LordKrishnaNameListScreenState(listIndex);
}

class _LordKrishnaNameListScreenState extends State<LordKrishnaNameListScreen> {

  bool isLanguageSelected = false;

  final int listIndex;

  _LordKrishnaNameListScreenState(this. listIndex);  //constructor
              ...
              children: [
                ...
                Expanded(
                    ...
                    ListView.builder(
                      ...
                      shrinkWrap: true,
                      itemCount:  lordKrishnaHindi.length,
                ...
                Expanded(
                    ...
                    ListView.builder(
                      physics: const NeverScrollableScrollPhysics(),
                      shrinkWrap: true,
                      itemCount: lordKrishnaEnglish.length,
                      itemBuilder: (context, i) {
                        return Column(
                          children: [
                            Row(
                              children: [
                                ...
                                Expanded(
                                  ...
                                  child: Padding(
                                    padding: const EdgeInsets.all(8.0),
                                    child: Text(""+lordKrishnaEnglish[i], style: GoogleFonts.aBeeZee(fontSize: 20.5, color: kprimarycolor,height: 1.5),textAlign: TextAlign.start,),
                                  ),
                                ),
                              ],
                            ),
