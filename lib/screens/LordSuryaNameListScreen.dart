...
class LordSuryaNameListScreen extends StatefulWidget {
  final int listIndex;

  const LordSuryaNameListScreen({Key? key,required this.listIndex}) : super(key: key);

  @override
  _LordSuryaNameListScreenState createState() => _LordSuryaNameListScreenState(listIndex);
}

class _LordSuryaNameListScreenState extends State<LordSuryaNameListScreen> {

  bool isLanguageSelected = false;

  final int listIndex;

  _LordSuryaNameListScreenState(this. listIndex);  //constructor
              ...
              children: [
                ...
                Expanded(
                    ...
                    ListView.builder(
                      ...
                      shrinkWrap: true,
                      itemCount:  lordSuryaHindi.length,
                ...
                Expanded(
                    ...
                    ListView.builder(
                      physics: const NeverScrollableScrollPhysics(),
                      shrinkWrap: true,
                      itemCount: lordSuryaEnglish.length,
                      itemBuilder: (context, i) {
                        return Column(
                          children: [
                            Row(
                              children: [
                                ...
                                Expanded(
                                  ...
                                  child: Padding(
                                    padding: const EdgeInsets.all(8.0),
                                    child: Text(""+lordSuryaEnglish[i], style: GoogleFonts.aBeeZee(fontSize: 21.5, color: kprimarycolor,height: 1.5),textAlign: TextAlign.start,),
                                  ),
                                ),
                              ],
                            ),
