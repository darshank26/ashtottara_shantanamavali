...
class LordShivaNameListScreen extends StatefulWidget {
  final int listIndex;

  const LordShivaNameListScreen({Key? key,required this.listIndex}) : super(key: key);

  @override
  _LordShivaNameListScreenState createState() => _LordShivaNameListScreenState(listIndex);
}

class _LordShivaNameListScreenState extends State<LordShivaNameListScreen> {

  bool isLanguageSelected = false;

  final int listIndex;

  _LordShivaNameListScreenState(this. listIndex);  //constructor
              ...
              children: [
                ...
                Expanded(
                    ...
                    ListView.builder(
                      ...
                      shrinkWrap: true,
                      itemCount:  lordShivaHindi.length,
                ...
                Expanded(
                    ...
                    ListView.builder(
                      physics: const NeverScrollableScrollPhysics(),
                      shrinkWrap: true,
                      itemCount: lordShivaEnglish.length,
                      itemBuilder: (context, i) {
                        return Column(
                          children: [
                            Row(
                              children: [
                                ...
                                Expanded(
                                  ...
                                  child: Padding(
                                    padding: const EdgeInsets.all(8.0),
                                    child: Text(""+lordShivaEnglish[i], style: GoogleFonts.aBeeZee(fontSize: 21.8, color: kprimarycolor,height: 1.5),textAlign: TextAlign.start,),
                                  ),
                                ),
                              ],
                            ),
