...
import 'package:ashtottara_shantanamavali/utils/LordChandraNameList.dart';
import 'package:ashtottara_shantanamavali/utils/LordShivaNameList.dart';
import 'package:ashtottara_shantanamavali/utils/LordSuryaNameList.dart';
...
class LordChandraNameListScreen extends StatefulWidget {
  final int listIndex;

  const LordChandraNameListScreen({Key? key,required this.listIndex}) : super(key: key);

  @override
  _LordChandraNameListScreenState createState() => _LordChandraNameListScreenState(listIndex);
}

class _LordChandraNameListScreenState extends State<LordChandraNameListScreen> {

  bool isLanguageSelected = false;

  final int listIndex;

  _LordChandraNameListScreenState(this. listIndex);  //constructor
              ...
              children: [
                ...
                Expanded(
                    ...
                    ListView.builder(
                      ...
                      shrinkWrap: true,
                      itemCount:  lordChandraHindi.length,
                              ...
                              children: [
                                ...
                                Expanded(
                                  ...
                                  child: Padding(
                                    ...
                                    child: Text(lordChandraHindi[i] ,
                                      style: GoogleFonts.aBeeZee(fontSize: 28.5, color: kprimarycolor,height: 1.5),textAlign: TextAlign.start,),
                                  ),
                                ),
                              ],
                            ),
                ...
                Expanded(
                    ...
                    ListView.builder(
                      physics: const NeverScrollableScrollPhysics(),
                      shrinkWrap: true,
                      itemCount: lordChandraEnglish.length,
                      itemBuilder: (context, i) {
                        return Column(
                          children: [
                            Row(
                              children: [
                                ...
                                Expanded(
                                  ...
                                  child: Padding(
                                    padding: const EdgeInsets.all(8.0),
                                    child: Text(""+lordChandraEnglish[i], style: GoogleFonts.aBeeZee(fontSize: 21.2, color: kprimarycolor,height: 1.5),textAlign: TextAlign.start,),
                                  ),
                                ),
                              ],
                            ),
