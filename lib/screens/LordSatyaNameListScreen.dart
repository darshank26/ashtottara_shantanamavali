...
import 'package:ashtottara_shantanamavali/utils/LordStayaNameList.dart';
...
class LordSatyaNameListScreen extends StatefulWidget {
  final int listIndex;

  const LordSatyaNameListScreen({Key? key,required this.listIndex}) : super(key: key);

  @override
  _LordSatyaNameListScreenState createState() => _LordSatyaNameListScreenState(listIndex);
}

class _LordSatyaNameListScreenState extends State<LordSatyaNameListScreen> {

  bool isLanguageSelected = false;

  final int listIndex;

  _LordSatyaNameListScreenState(this. listIndex);  //constructor
              ...
              children: [
                ...
                Expanded(
                    ...
                    ListView.builder(
                      ...
                      shrinkWrap: true,
                      itemCount:  lordSatyaHindi.length,
                ...
                Expanded(
                    ...
                    ListView.builder(
                      physics: const NeverScrollableScrollPhysics(),
                      shrinkWrap: true,
                      itemCount: lordSatyaEnglish.length,
                      itemBuilder: (context, i) {
                        return Column(
                          children: [
                            Row(
                              children: [
                                ...
                                Expanded(
                                  ...
                                  child: Padding(
                                    padding: const EdgeInsets.all(8.0),
                                    child: Text(""+lordSatyaEnglish[i], style: GoogleFonts.aBeeZee(fontSize: 21, color: kprimarycolor,height: 1.5),textAlign: TextAlign.start,),
                                  ),
                                ),
                              ],
                            ),
