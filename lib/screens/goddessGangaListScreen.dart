...
class LordGangaNameListScreen extends StatefulWidget {
  final int listIndex;

  const LordGangaNameListScreen({Key? key,required this.listIndex}) : super(key: key);

  @override
  _LordGangaNameListScreenState createState() => _LordGangaNameListScreenState(listIndex);
}

class _LordGangaNameListScreenState extends State<LordGangaNameListScreen> {

  bool isLanguageSelected = false;

  final int listIndex;

  _LordGangaNameListScreenState(this. listIndex);  //constructor
              ...
              children: [
                ...
                Expanded(
                    ...
                    ListView.builder(
                      ...
                      shrinkWrap: true,
                      itemCount:  goddessGangaHindi.length,
                              ...
                              children: [
                                ...
                                Expanded(
                                  ...
                                  child: Padding(
                                    ...
                                    child: Text(goddessGangaHindi[i] ,
                ...
                Expanded(
                    ...
                    ListView.builder(
                      physics: const NeverScrollableScrollPhysics(),
                      shrinkWrap: true,
                      itemCount: goddessGangaEnglish.length,
                      itemBuilder: (context, i) {
                        return Column(
                          children: [
                            Row(
                              children: [
                                ...
                                Expanded(
                                  ...
                                  child: Padding(
                                    padding: const EdgeInsets.all(8.0),
                                    child: Text(""+goddessGangaEnglish[i], style: GoogleFonts.aBeeZee(fontSize: 20, color: kprimarycolor,height: 1.5),textAlign: TextAlign.start,),
                                  ),
                                ),
                              ],
                            ),
