...
class LordNarsihaNameListScreen extends StatefulWidget {
  final int listIndex;

  const LordNarsihaNameListScreen({Key? key,required this.listIndex}) : super(key: key);

  @override
  _LordNarsihaNameListScreenState createState() => _LordNarsihaNameListScreenState(listIndex);
}

class _LordNarsihaNameListScreenState extends State<LordNarsihaNameListScreen> {

  bool isLanguageSelected = false;

  final int listIndex;

  _LordNarsihaNameListScreenState(this. listIndex);  //constructor
              ...
              children: [
                ...
                Expanded(
                    ...
                    ListView.builder(
                      ...
                      shrinkWrap: true,
                      itemCount:  lordNarasimhaHindi.length,
                              ...
                              children: [
                                ...
                                Expanded(
                                  ...
                                  child: Padding(
                                    ...
                                    child: Text(lordNarasimhaHindi[i] ,
                ...
                Expanded(
                    ...
                    ListView.builder(
                      physics: const NeverScrollableScrollPhysics(),
                      shrinkWrap: true,
                      itemCount: lordNarasimhaEnglish.length,
                      itemBuilder: (context, i) {
                        return Column(
                          children: [
                            Row(
                              children: [
                                ...
                                Expanded(
                                  ...
                                  child: Padding(
                                    padding: const EdgeInsets.all(8.0),
                                    child: Text(""+lordNarasimhaEnglish[i], style: GoogleFonts.aBeeZee(fontSize: 21.5, color: kprimarycolor,height: 1.5),textAlign: TextAlign.start,),
                                  ),
                                ),
                              ],
                            ),
