...
import 'package:ashtottara_shantanamavali/utils/LordHanumanNameList.dart';
import 'package:ashtottara_shantanamavali/utils/LordKrishnaNameList.dart';
import 'package:ashtottara_shantanamavali/utils/LordKuberaNameList.dart';
import 'package:ashtottara_shantanamavali/utils/LordNarsimhaNameList.dart';
...
class LordKuberaNameListScreen extends StatefulWidget {
  final int listIndex;

  const LordKuberaNameListScreen({Key? key,required this.listIndex}) : super(key: key);

  @override
  _LordKuberaNameListScreenState createState() => _LordKuberaNameListScreenState(listIndex);
}

class _LordKuberaNameListScreenState extends State<LordKuberaNameListScreen> {

  bool isLanguageSelected = false;

  final int listIndex;

  _LordKuberaNameListScreenState(this. listIndex);  //constructor
              ...
              children: [
                ...
                Expanded(
                    ...
                    ListView.builder(
                      ...
                      shrinkWrap: true,
                      itemCount:  lordKuberaHindi.length,
                              ...
                              children: [
                                ...
                                Expanded(
                                  ...
                                  child: Padding(
                                    ...
                                    child: Text(lordKuberaHindi[i] ,
                                      style: GoogleFonts.aBeeZee(fontSize: 27.8, color: kprimarycolor,height: 1.5),textAlign: TextAlign.start,),
                                  ),
                                ),
                              ],
                            ),
                ...
                Expanded(
                    ...
                    ListView.builder(
                      physics: const NeverScrollableScrollPhysics(),
                      shrinkWrap: true,
                      itemCount: lordKuberaEnglish.length,
                      itemBuilder: (context, i) {
                        return Column(
                          children: [
                            Row(
                              children: [
                                ...
                                Expanded(
                                  ...
                                  child: Padding(
                                    padding: const EdgeInsets.all(8.0),
                                    child: Text(""+lordKuberaEnglish[i], style: GoogleFonts.aBeeZee(fontSize: 21.5, color: kprimarycolor,height: 1.5),textAlign: TextAlign.start,),
                                  ),
                                ),
                              ],
                            ),
