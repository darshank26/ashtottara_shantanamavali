import 'dart:ui';
import 'package:ashtottara_shantanamavali/utils/GoddessDurgaNameList.dart';
import 'package:ashtottara_shantanamavali/utils/GoddessLaxmiNameList.dart';
import 'package:ashtottara_shantanamavali/utils/GoddessSaraswatiNameList.dart';
import 'package:ashtottara_shantanamavali/utils/GoddessSitaNameList.dart';
import 'package:ashtottara_shantanamavali/utils/LordSasthaNamesList.dart';
import 'package:ashtottara_shantanamavali/utils/LordSubNameList.dart';
import 'package:ashtottara_shantanamavali/utils/constants.dart';
import 'package:ashtottara_shantanamavali/utils/goddessGangaNameList.dart';
import 'package:ashtottara_shantanamavali/utils/goddessTulsiNameList.dart';
...
class LordTulsiNameListScreen extends StatefulWidget {
  final int listIndex;

  const LordTulsiNameListScreen({Key? key,required this.listIndex}) : super(key: key);

  @override
  _LordTulsiNameListScreenState createState() => _LordTulsiNameListScreenState(listIndex);
}

class _LordTulsiNameListScreenState extends State<LordTulsiNameListScreen> {

  bool isLanguageSelected = false;

  final int listIndex;

  _LordTulsiNameListScreenState(this. listIndex);  //constructor
              ...
              children: [
                ...
                Expanded(
                    ...
                    ListView.builder(
                      ...
                      shrinkWrap: true,
                      itemCount:  goddessTulsiHindi.length,
                              ...
                              children: [
                                ...
                                Expanded(
                                  ...
                                  child: Padding(
                                    ...
                                    child: Text(goddessTulsiHindi[i] ,
                                      style: GoogleFonts.aBeeZee(fontSize: 28, color: kprimarycolor,height: 1.5),textAlign: TextAlign.start,),
                                  ),
                                ),
                              ],
                            ),
                ...
                Expanded(
                    ...
                    ListView.builder(
                      physics: const NeverScrollableScrollPhysics(),
                      shrinkWrap: true,
                      itemCount: goddessTulsiEnglish.length,
                      itemBuilder: (context, i) {
                        return Column(
                          children: [
                            Row(
                              children: [
                                ...
                                Expanded(
                                  ...
                                  child: Padding(
                                    padding: const EdgeInsets.all(8.0),
                                    child: Text(""+goddessTulsiEnglish[i], style: GoogleFonts.aBeeZee(fontSize: 21.8, color: kprimarycolor,height: 1.5),textAlign: TextAlign.start,),
                                  ),
                                ),
                              ],
                            ),
