...
class LordSubNameListScreen extends StatefulWidget {
  final int listIndex;

  const LordSubNameListScreen({Key? key,required this.listIndex}) : super(key: key);

  @override
  _LordSubNameListScreenState createState() => _LordSubNameListScreenState(listIndex);
}

class _LordSubNameListScreenState extends State<LordSubNameListScreen> {

  bool isLanguageSelected = false;

  final int listIndex;

  _LordSubNameListScreenState(this. listIndex);  //constructor
              ...
              children: [
                ...
                Expanded(
                    ...
                    ListView.builder(
                      physics: const NeverScrollableScrollPhysics(),
                      shrinkWrap: true,
                      itemCount: lordSubEnglish.length,
                      itemBuilder: (context, i) {
                        return Column(
                          children: [
                            Row(
                              children: [
                                ...
                                Expanded(
                                  ...
                                  child: Padding(
                                    padding: const EdgeInsets.all(8.0),
                                    child: Text(""+lordSubEnglish[i], style: GoogleFonts.aBeeZee(fontSize: 21.5, color: kprimarycolor,height: 1.5),textAlign: TextAlign.start,),
                                  ),
                                ),
                              ],
                            ),
