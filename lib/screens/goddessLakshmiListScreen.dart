...
class LordLakshmiNameListScreen extends StatefulWidget {
  final int listIndex;

  const LordLakshmiNameListScreen({Key? key,required this.listIndex}) : super(key: key);

  @override
  _LordLakshmiNameListScreenState createState() => _LordLakshmiNameListScreenState(listIndex);
}

class _LordLakshmiNameListScreenState extends State<LordLakshmiNameListScreen> {

  bool isLanguageSelected = false;

  final int listIndex;

  _LordLakshmiNameListScreenState(this. listIndex);  //constructor
              ...
              children: [
                ...
                Expanded(
                    ...
                    ListView.builder(
                      ...
                      shrinkWrap: true,
                      itemCount:  goddessLakshmiHindi.length,
                              ...
                              children: [
                                ...
                                Expanded(
                                  ...
                                  child: Padding(
                                    ...
                                    child: Text(goddessLakshmiHindi[i] ,
                ...
                Expanded(
                    ...
                    ListView.builder(
                      physics: const NeverScrollableScrollPhysics(),
                      shrinkWrap: true,
                      itemCount: goddessLakshmiEnglish.length,
                      itemBuilder: (context, i) {
                        return Column(
                          children: [
                            Row(
                              children: [
                                ...
                                Expanded(
                                  ...
                                  child: Padding(
                                    padding: const EdgeInsets.all(8.0),
                                    child: Text(""+goddessLakshmiEnglish[i], style: GoogleFonts.aBeeZee(fontSize: 21.5, color: kprimarycolor,height: 1.5),textAlign: TextAlign.start,),
                                  ),
                                ),
                              ],
                            ),
