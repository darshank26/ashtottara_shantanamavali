...
class LordVishnuNameListScreen extends StatefulWidget {
  final int listIndex;

  const LordVishnuNameListScreen({Key? key,required this.listIndex}) : super(key: key);

  @override
  _LordVishnuNameListScreenState createState() => _LordVishnuNameListScreenState(listIndex);
}

class _LordVishnuNameListScreenState extends State<LordVishnuNameListScreen> {

  bool isLanguageSelected = false;

  final int listIndex;

  _LordVishnuNameListScreenState(this. listIndex);  //constructor
              ...
              children: [
                ...
                Expanded(
                    ...
                    ListView.builder(
                      ...
                      shrinkWrap: true,
                      itemCount:  lordVishnuHindi.length,
                ...
                Expanded(
                    ...
                    ListView.builder(
                      physics: const NeverScrollableScrollPhysics(),
                      shrinkWrap: true,
                      itemCount: lordVishnuEnglish.length,
                      itemBuilder: (context, i) {
                        return Column(
                          children: [
                            Row(
                              children: [
                                ...
                                Expanded(
                                  ...
                                  child: Padding(
                                    padding: const EdgeInsets.all(8.0),
                                    child: Text(""+lordVishnuEnglish[i], style: GoogleFonts.aBeeZee(fontSize: 21.5, color: kprimarycolor,height: 1.5),textAlign: TextAlign.start,),
                                  ),
                                ),
                              ],
                            ),
