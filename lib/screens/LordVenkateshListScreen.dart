...
import 'package:ashtottara_shantanamavali/utils/LordVentateshNameList.dart';
...
class LordVenkateshNameListScreen extends StatefulWidget {
  final int listIndex;

  const LordVenkateshNameListScreen({Key? key,required this.listIndex}) : super(key: key);

  @override
  _LordVenkateshNameListScreenState createState() => _LordVenkateshNameListScreenState(listIndex);
}

class _LordVenkateshNameListScreenState extends State<LordVenkateshNameListScreen> {

  bool isLanguageSelected = false;

  final int listIndex;

  _LordVenkateshNameListScreenState(this. listIndex);  //constructor
              ...
              children: [
                ...
                Expanded(
                    ...
                    ListView.builder(
                      ...
                      shrinkWrap: true,
                      itemCount:  lordVenkateshHindi.length,
                              ...
                              children: [
                                ...
                                Expanded(
                                  ...
                                  child: Padding(
                                    ...
                                    child: Text(lordVenkateshHindi[i] ,
                ...
                Expanded(
                    ...
                    ListView.builder(
                      physics: const NeverScrollableScrollPhysics(),
                      shrinkWrap: true,
                      itemCount: lordVenkateshEnglish.length,
                      itemBuilder: (context, i) {
                        return Column(
                          children: [
                            Row(
                              children: [
                                ...
                                Expanded(
                                  ...
                                  child: Padding(
                                    padding: const EdgeInsets.all(8.0),
                                    child: Text(""+lordVenkateshEnglish[i], style: GoogleFonts.aBeeZee(fontSize: 21.8, color: kprimarycolor,height: 1.5),textAlign: TextAlign.start,),
                                  ),
                                ),
                              ],
                            ),
