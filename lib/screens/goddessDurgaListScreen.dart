...
class LordDurgaNameListScreen extends StatefulWidget {
  final int listIndex;

  const LordDurgaNameListScreen({Key? key,required this.listIndex}) : super(key: key);

  @override
  _LordDurgaNameListScreenState createState() => _LordDurgaNameListScreenState(listIndex);
}

class _LordDurgaNameListScreenState extends State<LordDurgaNameListScreen> {

  bool isLanguageSelected = false;

  final int listIndex;

  _LordDurgaNameListScreenState(this. listIndex);  //constructor
              ...
              children: [
                ...
                Expanded(
                    ...
                    ListView.builder(
                      ...
                      shrinkWrap: true,
                      itemCount:  goddessDurgaHindi.length,
                              ...
                              children: [
                                ...
                                Expanded(
                                  ...
                                  child: Padding(
                                    ...
                                    child: Text(goddessDurgaHindi[i] ,
                ...
                Expanded(
                    ...
                    ListView.builder(
                      physics: const NeverScrollableScrollPhysics(),
                      shrinkWrap: true,
                      itemCount: goddessDurgaEnglish.length,
                      itemBuilder: (context, i) {
                        return Column(
                          children: [
                            Row(
                              children: [
                                ...
                                Expanded(
                                  ...
                                  child: Padding(
                                    padding: const EdgeInsets.all(8.0),
                                    child: Text(""+goddessDurgaEnglish[i], style: GoogleFonts.aBeeZee(fontSize: 22, color: kprimarycolor,height: 1.5),textAlign: TextAlign.start,),
                                  ),
                                ),
                              ],
                            ),
