...
class LordSitaNameListScreen extends StatefulWidget {
  final int listIndex;

  const LordSitaNameListScreen({Key? key,required this.listIndex}) : super(key: key);

  @override
  _LordSitaNameListScreenState createState() => _LordSitaNameListScreenState(listIndex);
}

class _LordSitaNameListScreenState extends State<LordSitaNameListScreen> {

  bool isLanguageSelected = false;

  final int listIndex;

  _LordSitaNameListScreenState(this. listIndex);  //constructor
              ...
              children: [
                ...
                Expanded(
                    ...
                    ListView.builder(
                      ...
                      shrinkWrap: true,
                      itemCount:  goddessSitaHindi.length,
                ...
                Expanded(
                    ...
                    ListView.builder(
                      physics: const NeverScrollableScrollPhysics(),
                      shrinkWrap: true,
                      itemCount: goddessSitaEnglish.length,
                      itemBuilder: (context, i) {
                        return Column(
                          children: [
                            Row(
                              children: [
                                ...
                                Expanded(
                                  ...
                                  child: Padding(
                                    padding: const EdgeInsets.all(8.0),
                                    child: Text(""+goddessSitaEnglish[i], style: GoogleFonts.aBeeZee(fontSize: 20, color: kprimarycolor,height: 1.5),textAlign: TextAlign.start,),
                                  ),
                                ),
                              ],
                            ),
