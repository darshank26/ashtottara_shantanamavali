...
import 'package:ashtottara_shantanamavali/utils/LordShaniNameList.dart';
...
class LordShaniNameListScreen extends StatefulWidget {
  final int listIndex;

  const LordShaniNameListScreen({Key? key,required this.listIndex}) : super(key: key);

  @override
  _LordShaniNameListScreenState createState() => _LordShaniNameListScreenState(listIndex);
}

class _LordShaniNameListScreenState extends State<LordShaniNameListScreen> {

  bool isLanguageSelected = false;

  final int listIndex;

  _LordShaniNameListScreenState(this. listIndex);  //constructor
              ...
              children: [
                ...
                Expanded(
                    ...
                    ListView.builder(
                      ...
                      shrinkWrap: true,
                      itemCount:  lordShaniHindi.length,
                ...
                Expanded(
                    ...
                    ListView.builder(
                      physics: const NeverScrollableScrollPhysics(),
                      shrinkWrap: true,
                      itemCount: lordShaniEnglish.length,
                      itemBuilder: (context, i) {
                        return Column(
                          children: [
                            Row(
                              children: [
                                ...
                                Expanded(
                                  ...
                                  child: Padding(
                                    padding: const EdgeInsets.all(8.0),
                                    child: Text(""+lordShaniEnglish[i], style: GoogleFonts.aBeeZee(fontSize: 21.5, color: kprimarycolor,height: 1.5),textAlign: TextAlign.start,),
                                  ),
                                ),
                              ],
                            ),
