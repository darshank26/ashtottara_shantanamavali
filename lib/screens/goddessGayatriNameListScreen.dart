...
import 'package:ashtottara_shantanamavali/utils/goddessGayatriNameList.dart';
...
class LordGayatriNameListScreen extends StatefulWidget {
  final int listIndex;

  const LordGayatriNameListScreen({Key? key,required this.listIndex}) : super(key: key);

  @override
  _LordGayatriNameListScreenState createState() => _LordGayatriNameListScreenState(listIndex);
}

class _LordGayatriNameListScreenState extends State<LordGayatriNameListScreen> {

  bool isLanguageSelected = false;

  final int listIndex;

  _LordGayatriNameListScreenState(this. listIndex);  //constructor
              ...
              children: [
                ...
                Expanded(
                    ...
                    ListView.builder(
                      ...
                      shrinkWrap: true,
                      itemCount:  goddessGayatriHindi.length,
                              ...
                              children: [
                                ...
                                Expanded(
                                  ...
                                  child: Padding(
                                    ...
                                    child: Text(goddessGayatriHindi[i] ,
                                      style: GoogleFonts.aBeeZee(fontSize: 29, color: kprimarycolor,height: 1.5),textAlign: TextAlign.start,),
                                  ),
                                ),
                              ],
                            ),
                ...
                Expanded(
                    ...
                    ListView.builder(
                      physics: const NeverScrollableScrollPhysics(),
                      shrinkWrap: true,
                      itemCount: goddessGayatrienglish.length,
                      itemBuilder: (context, i) {
                        return Column(
                          children: [
                            Row(
                              children: [
                                ...
                                Expanded(
                                  ...
                                  child: Padding(
                                    padding: const EdgeInsets.all(8.0),
                                    child: Text(""+goddessGayatrienglish[i], style: GoogleFonts.aBeeZee(fontSize: 22, color: kprimarycolor,height: 1.5),textAlign: TextAlign.start,),
                                  ),
                                ),
                              ],
                            ),
