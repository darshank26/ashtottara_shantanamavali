...
class LordHanumanNameListScreen extends StatefulWidget {
  final int listIndex;

  const LordHanumanNameListScreen({Key? key,required this.listIndex}) : super(key: key);

  @override
  _LordHanumanNameListScreenState createState() => _LordHanumanNameListScreenState(listIndex);
}

class _LordHanumanNameListScreenState extends State<LordHanumanNameListScreen> {

  bool isLanguageSelected = false;

  final int listIndex;

  _LordHanumanNameListScreenState(this. listIndex);  //constructor
              ...
              children: [
                ...
                Expanded(
                    ...
                    ListView.builder(
                      ...
                      shrinkWrap: true,
                      itemCount:  lordHanumanHindi.length,
                ...
                Expanded(
                    ...
                    ListView.builder(
                      physics: const NeverScrollableScrollPhysics(),
                      shrinkWrap: true,
                      itemCount: lordHanumanEnglish.length,
                      itemBuilder: (context, i) {
                        return Column(
                          children: [
                            Row(
                              children: [
                                ...
                                Expanded(
                                  ...
                                  child: Padding(
                                    padding: const EdgeInsets.all(8.0),
                                    child: Text(""+lordHanumanEnglish[i], style: GoogleFonts.aBeeZee(fontSize: 21, color: kprimarycolor,height: 1.5),textAlign: TextAlign.start,),
                                  ),
                                ),
                              ],
                            ),
