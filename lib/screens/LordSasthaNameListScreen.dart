...
class LordSasthaNameListScreen extends StatefulWidget {
  final int listIndex;

  const LordSasthaNameListScreen({Key? key,required this.listIndex}) : super(key: key);

  @override
  _LordSasthaNameListScreenState createState() => _LordSasthaNameListScreenState(listIndex);
}

class _LordSasthaNameListScreenState extends State<LordSasthaNameListScreen> {

  bool isLanguageSelected = false;

  final int listIndex;

  _LordSasthaNameListScreenState(this. listIndex);  //constructor
              ...
              children: [
                ...
                Expanded(
                    ...
                    ListView.builder(
                      ...
                      shrinkWrap: true,
                      itemCount:  lordSasthaHindi.length,
                ...
                Expanded(
                    ...
                    ListView.builder(
                      physics: const NeverScrollableScrollPhysics(),
                      shrinkWrap: true,
                      itemCount: lordSasthaEnglish.length,
                      itemBuilder: (context, i) {
                        return Column(
                          children: [
                            Row(
                              children: [
                                ...
                                Expanded(
                                  ...
                                  child: Padding(
                                    padding: const EdgeInsets.all(8.0),
                                    child: Text(""+lordSasthaEnglish[i], style: GoogleFonts.aBeeZee(fontSize: 21.5, color: kprimarycolor,height: 1.5),textAlign: TextAlign.start,),
                                  ),
                                ),
                              ],
                            ),
