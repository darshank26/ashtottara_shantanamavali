...
class LordSaraswatiNameListScreen extends StatefulWidget {
  final int listIndex;

  const LordSaraswatiNameListScreen({Key? key,required this.listIndex}) : super(key: key);

  @override
  _LordSaraswatiNameListScreenState createState() => _LordSaraswatiNameListScreenState(listIndex);
}

class _LordSaraswatiNameListScreenState extends State<LordSaraswatiNameListScreen> {

  bool isLanguageSelected = false;

  final int listIndex;

  _LordSaraswatiNameListScreenState(this. listIndex);  //constructor
              ...
              children: [
                ...
                Expanded(
                    ...
                    ListView.builder(
                      ...
                      shrinkWrap: true,
                      itemCount:  goddessSaraswatiHindi.length,
                              ...
                              children: [
                                ...
                                Expanded(
                                  ...
                                  child: Padding(
                                    ...
                                    child: Text(goddessSaraswatiHindi[i] ,
                ...
                Expanded(
                    ...
                    ListView.builder(
                      physics: const NeverScrollableScrollPhysics(),
                      shrinkWrap: true,
                      itemCount: goddessSaraswatiEnglish.length,
                      itemBuilder: (context, i) {
                        return Column(
                          children: [
                            Row(
                              children: [
                                ...
                                Expanded(
                                  ...
                                  child: Padding(
                                    padding: const EdgeInsets.all(8.0),
                                    child: Text(""+goddessSaraswatiEnglish[i], style: GoogleFonts.aBeeZee(fontSize: 21.5, color: kprimarycolor,height: 1.5),textAlign: TextAlign.start,),
                                  ),
                                ),
                              ],
                            ),
